...
function parse(pathname: string): Route {
  ...
  if (first === 'repo-detail' && second) {
    return { panel: 'repo-detail', runId: null, showLaunch: false, repoId: decodeURIComponent(second), showRegisterRepo: false, chatMode: false };
  }
  ...
  if (second) return { panel: 'runs', runId: decodeURIComponent(second), showLaunch: false, repoId: null, showRegisterRepo: false, chatMode: false };
