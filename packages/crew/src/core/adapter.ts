...
export const BUILTIN_WORKFLOWS: WorkflowDef[] = [
  ...
  // work mode, unlike the dedicated-entry-point workflows above.
  {
    ...
    phases: [
      ...
      { id: 'coverage', kind: 'test', gate_type: 'execution', gate: { human_confirm_if: 'verdict_not_pass' }, executes_code: false, verified_evidence: true, required_deliverables: ['coverage-report.json'], depends_on: ['extract'], role: 'evaluator', skill_ref: 'wicked-garden-domain-coverage', allowed_skills: [], validator_pin: 'f8efe773ea4b61db' },
